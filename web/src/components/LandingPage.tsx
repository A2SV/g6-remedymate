...
import { AlertTriangle, HeartPlus, WifiOff, Stethoscope, ListChecks, Lightbulb, ShieldAlert } from "lucide-react"
...
const LandingPage = () => {
  return (
    <div>
      <main>
        {/* Hero Section */}
        <section className="flex flex-col md:flex-row items-center w-full min-h-[500px] text-white bg-[hsl(212,70%,24%)] px-6 md:px-17 py-10 md:gap-20">
        {/* Left Side - Text */}
        <div className="flex-1.2 mt-6 md:mt-14 max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            ...
            <Button
              variant="secondary"
              size="lg"
              className="bg-[#F59E0B] flex items-center gap-2 h-13"
            >
        ...
        <section className="text-white bg-[hsl(212,70%,24%)] px-6 md:px-17 py-12 w-full">
          ...
          {/* First row */}
          <div className="flex flex-col md:flex-row gap-50 mb-6">
            <div className="p-7 bg-white rounded-[20px] text-center max-w-sm w-full">
        ...
        {/* Testimonials */}
        <section className="w-full py-12 px-6 md:px-17">
...
const FeatureCard = ({ icon, title, desc }) => (
  <div className="bg-white px-5 py-5 rounded-[20px]">
    <div className="flex items-center gap-2 mb-2">{icon}<h1 className="text-black text-[16px]">{title}</h1></div>
    <p className="text-gray-400 text-sm">{desc}</p>
  </div>
)

// const StepCard = ({ icon, title, desc }) => (
//   <div className="p-7 bg-white rounded-[20px] text-center">
//     {icon}
