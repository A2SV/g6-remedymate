...
const trustPoints = [
	...
	},
	{
		...
		description: "Book same-day appointments with top-rated healthcare professionals.",
	},
	{
		icon: Heart,
		title: "Affordable Health Hub",
		description: "Access quality healthcare at transparent, affordable prices that fit your budget.",
	},
];
			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="max-w-3xl mx-auto text-center mb-12 sm:mb-16">
					...
					<p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
						Join thousands who trust Healo for their healthcare needs. We&apos;re committed to your
						wellbeing.
					</p>
				</div>
				...
				<div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
					...
					<div className="space-y-4 sm:space-y-6 order-2 lg:order-1">
						...
						<Button size="lg" className="rounded-full w-full sm:w-auto shadow-soft mt-6">
							Get Started
						</Button>
					</div>
					...
					<div className="relative order-1 lg:order-2">
						<div className="max-w-lg mx-auto lg:mr-auto">
							<div className="relative">
								{/* Glow Effect */}
								<div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-[hsl(280_80%_70%/0.2)] rounded-3xl blur-2xl" />
