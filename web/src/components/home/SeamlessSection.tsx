...
const benefits = [
	...
	},
	{
		...
		description:
			'Book appointments, schedule consultations, or order medicines—all in a few taps from your phone.',
	},
	{
		icon: Zap,
		title: 'Get Care Fast',
...
const SeamlessSection = () => {
	return (
		<section id="howitworks" className="py-16 sm:py-24 bg-secondary/30">
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="max-w-3xl mx-auto text-center mb-12 sm:mb-16">
					...
					<p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
						Your health companion that travels with you. Access
						world-class healthcare from the palm of your hand.
					</p>
				</div>
					...
					<div className="order-1 lg:order-2 space-y-6">
						{benefits.map((benefit, index) => {
							...
							return (
								<Card
									key={index}
									className="border-border hover:shadow-soft transition-smooth"
								>
