const Activity = () => {
	return (
		<div className="rounded-lg border border-gray-300 p-4 bg-white mb-5">
			...
			<div className="text-black p-3 border bg-white/70 border-gray-200 rounded-2xl w-full text-center">
