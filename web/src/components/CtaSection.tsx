...
const CtaSection = () => {
	return (
		<section className="py-16 sm:py-24 bg-background relative overflow-hidden">
			{/* Gradient Background */}
			<div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-[hsl(280_80%_70%/0.05)]" />
				...
				<div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
					...
					<div className="order-2 lg:order-1">
						...
						<p className="text-base sm:text-lg text-muted-foreground mb-8 leading-relaxed">
							Take control of your health today. Download Healo and experience healthcare that revolves
							around you—simple, accessible, and always there when you need it.
						</p>

						<div className="flex flex-col sm:flex-row gap-4">
							<Button size="lg" className="rounded-full gap-2 shadow-soft">
								<Apple className="w-5 h-5" />
								App Store
							</Button>
							<Button size="lg" variant="outline" className="rounded-full gap-2 border-2">
